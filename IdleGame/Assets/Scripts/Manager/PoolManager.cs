...
////    {
////        // ContainsKey(Key) 해당 키가 딕셔너리에 있는지 판단
////        if (pool_dict.ContainsKey(path) == false)
////        {
////            Add_pool(path);
////            //Add_pool이 public 이 아닌 private로 짜인 이유
...
////        //Resources.Load() 는 유니티 프로젝트 내의 Resources 폴더로부터
////        //경로에 맞는 <T> 를 로드하는 기능
